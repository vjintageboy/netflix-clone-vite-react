      ...
      <div className="w-[100%] animate-fade animate-once animate-duration-1000 animate-delay-[0ms] animate-ease-out">
        <div className="animate-fade animate-once animate-duration-00 animate-delay-[0ms] animate-ease-out">
          <img
            src={ly1}
            alt="One Piece"
            className="animate-fade animate-once animate-duration-00 animate-delay-[0ms] animate-ease-out"
          />
          ...
          <p className="netflix-description animate-fade animate-once animate-duration-00 animate-delay-[0ms] animate-ease-out">
            Sophie vốn dĩ làm việc tại cửa hàng mũ do người cha quá cố để lại.
            Cuộc sống nơi thị trấn buồn tẻ cứ thế trôi qua trong lặng lẽ... cho
            đến ngày cô bỗng biến thành bà lão.
          </p>
          ...
          <div className="flex gap-3 mt-[1.5vw] whitespace-nowrap animate-fade animate-once animate-duration-1000 animate-delay-[0ms] animate-ease-out">
            ...
            <button
              className="netflix-button gap-3 flex items-center justify-center px-8 py-3 !text-lg rounded !bg-white text-black hover:!bg-gray-300 !border-none cursor-pointer transition-all duration-300 ease-in-out transform hover:scale-105"
              style={{
                fontWeight: "900",
            ...
            <button
              className="netflix-button gap-3 flex items-center justify-center px-[1.6rem] py-[0.8rem] !text-lg rounded !bg-[rgba(109,109,110,0.7)] text-white ml-4 hover:!bg-[rgba(109,109,110,0.4)] !border-none cursor-pointer transition-all duration-300 ease-in-out transform hover:scale-105"
              style={{
                fontWeight: "900",
