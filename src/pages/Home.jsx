    ...
    return (
        <>
            ...
            <div className="text-white h-screen flex items-center justify-center w-full relative overflow-hidden">
                {/* Background fallback */}
                <div
                    className={`absolute top-0 left-0 w-full h-full bg-cover bg-center bg-no-repeat z-0 transition-opacity duration-1000 ${isReady && !videoEnded ? 'opacity-0' : 'opacity-100'}`}
